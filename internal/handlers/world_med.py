...
class CartogramHandler(handlers.base_handler.BaseCartogramHandler):
    ...
    def get_gen_file(self):
        return "{}/world_med_processedmap.json".format(settings.CARTOGRAM_DATA_DIR)
