...
CARTOGRAM_GA_TRACKING_ID = os.environ['CARTOGRAM_GA_TRACKING_ID']

CARTOGRAM_LOCAL_DOCKERIZED = True if os.environ['CARTOGRAM_LOCAL_DOCKERIZED'].lower() == "true" else False
